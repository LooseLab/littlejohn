...
class JobLogger:
    ...
    def __init__(self, logger: logging.Logger, job_id: str = None, job_type: str = None, filepath: str = None):
        self.logger = logger
        self.job_id = job_id
...
class LogManager:
    ...
    def get_job_logger(self, job_id: str, job_type: str, filepath: str = None, level: str = None) -> JobLogger:
